...
{
	internal class Dialog : Window, INotifyPropertyChanged
	{
		...
		//For designer
		//Do not use
		public Dialog() : this("The quick brown fox jumps over the lazy dog", null)
		{
	...
	internal readonly struct FontWeightStyle : IComparable<FontWeightStyle>
	{
		...
		public bool Equals(FontWeightStyle rhs)
